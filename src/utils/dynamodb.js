...
const hasAWSCredentials = () => {
  return !!(process.env.AWS_ACCESS_KEY_ID || process.env.AWS_PROFILE || process.env.AWS_CONFIG_FILE);
};
...
if (hasAWSCredentials()) {
  ...
  database = new DynamoDBService();
} else {
  // Use mock database for testing
  console.warn('AWS credentials not found. Using mock database for development/testing.');
  database = require('./dynamodb-mock');
}
